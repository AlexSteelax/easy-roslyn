...
using System.IO;
using System.Text;
using static Steelax.EasyRoslyn.Collections.SourceBag;

namespace Steelax.EasyRoslyn.Collections;

public sealed class SourceBag : IEnumerable<SourceBagItem>
{
    readonly List<SourceBagItem> sources = [];
